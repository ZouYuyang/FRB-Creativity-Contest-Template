...
\date{二〇二二年四月}
\headofpaper{北京航空航天大学第三十X届“冯如杯”竞赛创意赛道参赛作品}
...
\addcontentsline{toc}{section}{但是你又想在目录里看到这章，那么就加上这行}
...
原文：本项目在 Manjaro Linux 以及 WSL-ArchLinux 平台的 TeXLive 2020 的测试，通过通过 \hologo{XeLaTeX} + \hologo{BibTeX} * 2 + \hologo{XeLaTeX}，生成完整的参考文献论文。
